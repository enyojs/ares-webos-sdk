...
(function () {
    ...
    function outputPackage(destination, pkgName, pkgVersion, next) {
        if (this.rom) {
            ...
            async.series([
                decidePkgName.bind(this, pkgName, pkgVersion, destination),
    ...
    function decidePkgName(pkgName, pkgVersion, destination, next) {
        if (this.appCount !== 0) {
            this.pkg = {
            ...
            this.pkg = {
                name : pkgName || path.basename(destination) || "unknown",
                version : pkgVersion || "1.0.0"
            };
        }
        setImmediate(next);
