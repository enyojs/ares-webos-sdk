...
function showUsage() {
	var helpString = [
		"",
		"NAME",
		help.format(processName + " - Installs applications on the emulator or on the webOS TV."),
		"",
		"SYNOPSIS",
		help.format(processName + " [COMMAND]"),
		help.format(processName + " [OPTIONS] <PACKAGE_FILE>"),
		help.format(processName + " [OPTIONS] --remove, -r <APP_ID>"),
		help.format(processName + " [OPTIONS] --list, -l"),
		"",
		"DESCRIPTION",
		help.format("Install .ipk package into TARGET DEVICE if only putting <PACKAGE_FILE>"),
		"",
		help.format("'--remove' means removing an installed app having <APP_ID>"),
		help.format("'--list' means displaying the list of installed applications."),
		"",
