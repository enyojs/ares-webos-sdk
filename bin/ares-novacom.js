...
var helpString = [
	...
	help.format(processName + " [OPTION...] -K, --privatekey <PRIVATE_KEY_NAME> --passphrase, -P <PASSPHASE> --device, -d <DEVICE_NAME>"),
...
//	"",
	...
	help.format("This option is available only when device is running <DEVELOPER MODE APP>."),
	help.format("Emulator does not need ssh key configuration, initially it is already configurated."),
	"",
	help.format("(Note) If user configure a ssh registration manually without <DEVELOPER MODE APP>"),
...
//	help.format("'--password' is available"),
	...
	"Examples:",
	"",
	"# Initiate ssh key configuration for tv running <DEVELOPER MODE APP>",
