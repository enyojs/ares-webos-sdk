...
function PalmGenerate() {
	...
	this.helpString = [
		...
		help.format("-l, --list [string]", "List the available templates corresponeded with TYPE [default: " + this.defaultSourceType + "]"),
		help.format("", "available TYPE is 'template', 'webosConfig', 'webosService'"),
		help.format("-h, --help", "Display this help"),
		help.format("-V, --version", "Display version info"),
		"",
		"OPTIONS:",
		help.format("-t, --template [string]", "Use the template named TEMPLATE"),
		help.format("", "TEMPLATE can be searched via " + processName + " --list, -l"),
		help.format("-p, --property [string]", "Set the property PROPERTY"),
