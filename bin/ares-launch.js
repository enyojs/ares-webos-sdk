...
function showUsage() {
	var helpString = [
		"",
		"NAME",
		help.format(processName + " - Runs and terminates the application."),
		"",
		"SYNOPSIS",
		help.format(processName + " [COMMAND]"),
		help.format(processName + " [OPTIONS] <APP_ID>"),
		help.format(processName + " [OPTIONS] --close, -c <APP_ID>"),
		help.format(processName + " [OPTIONS] --running, -r"),
		help.format(processName + " [OPTIONS] --hosted, -H <APP_DIR>"),
		"",
		"DESCRIPTION",
		help.format("Launch an app having <APP_ID> on the TARGET DEVICE"),
		"",
		help.format("If using '--close', close an app having <APP_ID>"),
		"",
		help.format("If using '--running', show the list running apps on the target."),
		"",
		help.format("If using '--hosted', launch an app as hosted mode"),
		...
		"",
		help.format("--inspect, -i"),
		help.format("\t launch app with a web inspector"),
		"",
		help.format("--level"),
