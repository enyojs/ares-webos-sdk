...
function PalmPackage() {
	...
	this.helpString = [
		...
		help.format("-o, --outdir [path]", "Use OUTPUT_DIR as the output directory"),
		help.format("-n, --no-minify", "Skip the minification phase"),
		help.format("-e, --app-exclude [path]", "Use EXCLUDE_DIR to exclude dir in package"),
		...
		help.format("-r, --rom [boolean]", "Do not create ipk, instead output a folder structure"),
		help.format("", "to OUTPUT_DIR suitable for inclusion in webOS ROM image"),
		help.format("-d, --deployscript [path]", "Set path to enyo deploy script"),
